 ...
 *
 *	@(#)tmreg.h	1.1 (2.10BSD Berkeley) 12/1/86
 */
...
/* TM_SENSE is a pseudo-op used to get tape status */
...
#define	TMER_NXM	0000200		/* non-existent memory */
...
#define	TMER_HARD	(TMER_ILC|TMER_EOT|TMER_NXM)
#define	TMER_SOFT	(TMER_CRE|TMER_PAE|TMER_BGL|TMER_RLE|TMER_BTE)
