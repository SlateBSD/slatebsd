...
#ifdef BSD2_10
#define	runiquehelp	h_runique
#define	connecthelp	h_connect
#define	accounthelp	h_account
#define	verbosehelp	h_verbose
#define	suniquehelp	h_sunique
#define	mdeletehelp	h_mdelete
#endif
