...
#ifdef BSD2_10
#define	this_line		_tsln
#define	this_line_is_command	_tslncm
#define	this_line_is_stars	_tslnst
#define	last_line_was_command	_lslncm
#define	last_line_was_stars	_lslnst
#endif
