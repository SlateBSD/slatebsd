...
L_INT cframe;
{
	...
	DO IF symflg>=2 ANDF symflg<=4
	   ...
	   THEN localval=leng(lastframe+2*symbol.symv-(overlay?12:10));
		return(TRUE);
	   FI
	OD
	return(FALSE);
